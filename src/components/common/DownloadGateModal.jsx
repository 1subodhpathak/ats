  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl">
        ...
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-cyan-50 text-cyan-600 border border-cyan-200 shadow-xs">
        ...
        <div className="mt-6 grid gap-3">
          <button
            ...
            disabled={loading}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-600 to-teal-600 px-5 py-3 text-sm font-bold text-white shadow-md transition hover:from-cyan-700 hover:to-teal-700 active:translate-y-0.5 disabled:opacity-60"
          >
